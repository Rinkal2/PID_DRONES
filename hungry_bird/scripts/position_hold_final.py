...
class Edrone():
	...
	def __init__(self):
		...
		self.setpoint = [1.1094,-0.6597,1.5194,0.0] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
