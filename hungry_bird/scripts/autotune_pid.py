...
class Tune():
    def __init__(self, pid_effort_topic, max, min, step, threshold_time, index):
        ...
        self.index = index
	rospy.Subscriber('/statespecs/poses', Point, self.get_statepose)
    ...
    def auto_ZN (self, start_kp):
        ...
        for i in range (100):
            ...
            rospy.wait_for_message("statespecs/poses", Point)
            #print "here"
            ...
            if (i == 0):
                ...
                initial_error.append(30 - self.state.z)    # Get the sign of the initial error
            ...
            new_error.append(30 - self.state.z)   #Sign of the new error
            ...
            # Want to see significant oscillation
                if (time1 > self.thresh):
                    ...
                    self.pid_value.Kp = int(0.2 * Ku)
                    self.pid_value.Ki = int(2 * Ku / time1)*0
...
if __name__ == '__main__':
    throt_pid_tune = Tune("/pid_tuning_altitude", 5000, 1200, 200, 2, 2)
